...
public class TryOutReadTableMain004 {
...
//			Enum<AreaType> enumAreaType = objCell.getAreaType();
			...
			USCityPersisted004 objCity = (USCityPersisted004)obj;
			...
			Enum<USState004> enumUSState = objCity.getUSStateObject(); 
			
			System.out.println("Name / Bezeichnung / Abkürzung: " + enumUSState.name() + "/" + enumUSState.toString() + "/" + ((USState004) enumUSState).getAbbreviation());
		}
